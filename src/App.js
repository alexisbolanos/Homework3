    ...
    return (
      <div className="App">
        ...
        <div className="form-group row">
          ...
          <div class="card text-center border-secondary mb-3">
            ...
            <div className="form-group row">
              <div className="form-group col-md-2">
                <label className="font-weight-bold" htmlFor="">DATE</label>
              </div>
            ...
            <div className="form-group row">
              <div className="form-group col-md-2">
                <label className="font-weight-bold" htmlFor="">CANT</label>
              </div>
              <div className="form-group col-md-10">
            ...
            <div className="form-group row">
              <div className="form-group col-md-2">
                <label className="font-weight-bold" htmlFor="">$</label>
              </div>
              <div className="form-group  col-md-10">
            ...
            <button  onClick={() => this.addData()} className="btn-xs btn-info">ADD</button>
            </div>
          </div>
          ...
          <div className="col-md-3" key="1">
          <div class="card text-center border-secondary mb-3">
              <div className="card-header bg-transparent border-secondary">DATES (X)</div>
          ...
          <div class="card text-center border-secondary mb-3">
                  <div className="card-header bg-transparent border-secondary">CONT (Y1)</div>
                  <div className="card-body text-success">
          ...
          <div class="card text-center border-secondary mb-3">
              <div className="card-header bg-transparent border-secondary">COST (Y2)</div>
              <div className="card-body text-success">
              {fechas.map((fecha, i) => (
